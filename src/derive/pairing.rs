#[macro_export]
macro_rules! impl_pairing_engine {
    (
    $engine:ident,
    $g1:ident,
    $g1affine:ident,
...
macro_rules! impl_gt {
    (
        ...
        impl_binops_additive!($target, $target);
        impl_binops_multiplicative!($target, $scalar);
        ...
        impl Group for $target {
            ...
            fn generator() -> Self {
                $engine::pairing(&G1Affine::generator(), &G2Affine::generator())
            }
