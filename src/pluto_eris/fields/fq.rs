...
///
/// `q = 0x24000000000024000130e0000d7f70e4a803ca76f439266f443f9a5cda8a6c7be4a7a5fe8fadffd6a2a7e8c30006b9459ffffcd300000001`
///
...
const GENERATOR: Fq = Fq::from_raw([0x0a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
...
mod test {
    ...
    #[test]
    fn test_field() {
        crate::tests::field::random_field_tests::<Fq>("Eris scalar".to_string());
    }
