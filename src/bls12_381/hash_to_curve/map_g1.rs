...
use crate::bls12_381::g1::G1Projective;
use crate::bls12_381::generic_array::{typenum::U64, GenericArray};
use ff::Field;
...
fn test_encode_to_curve_10() {
    ...
    for case in cases {
        ...
        let g_uncompressed = aff.to_uncompressed_be();
...
fn test_hash_to_curve_10() {
    ...
    for case in cases {
        ...
        let g_uncompressed = G1Affine::from(g).to_uncompressed_be();
