...
macro_rules! curve_testing_suite {
    ($($curve: ident),*) => {
        ...
        mod tests {
            ...
            fn test_curve() {
                $(
                    crate::tests::curve::curve_tests::<$curve>();
                )*
            }
            ...
            fn test_hash_to_curve() {
                $(
                    crate::tests::curve::hash_to_curve_test::<$curve>();
                )*
            }
            ...
            fn test_serialization() {
                $(
                    crate::tests::curve::random_serialization_test::<$curve>();
                    #[cfg(feature = "derive_serde")]
...
pub(crate) use curve_testing_suite;
