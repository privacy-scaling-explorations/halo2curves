use super::fq::Fq;
use super::fq2::Fq2;
use crate::{ff::Field, field_cubic_ext};
...
field_cubic_ext!(Fq6, Fq2, FROBENIUS_COEFF_FQ6);

// TODO Doc
const FROBENIUS_COEFF_FQ6: [[Fq2; 6]; 2] = [FROBENIUS_COEFF_FQ6_C1, FROBENIUS_COEFF_FQ6_C2];
// TODO Check visibility (needed in Fp12 ATM)
// TODO Doc
...
const FROBENIUS_COEFF_FQ6_C2: [Fq2; 6] = [
    // Fq2(u + 9)**(((2q^0) - 2) / 3)
    Fq2 {
        c0: Fq([
            0xd35d438dc58f0d9d,
